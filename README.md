...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://qr-scan.mwastechnexus.co.ke) Or [`PARING CODE`](https://replit.com/@BrianMwangi9/MWAS-MD-Pairing-Code#index.js). And then `Go-to Whatapp>Three dots>Linked Devices`***
